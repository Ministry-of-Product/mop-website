---
title: "Big Slice / Small Slice (BSSS)"
summary: A milestone-based ownership framework for early ventures — how contribution earns a proportional stake without assigning equity upfront.
order: 1
permalink: /workbench/big-slice-small-slice/
description: Big Slice / Small Slice (BSSS) is the Ministry of Product framework for allocating ownership dynamically and transparently in early ventures.
meta_description: Big Slice / Small Slice (BSSS) — a milestone-based ownership framework where contribution earns a proportional stake. The rules, vocabulary, and recommended allocation.
---

<span class="eyebrow">The Workbench · Ownership</span>
...
This is the ownership engine behind the [Venture Studio](/venture-studio/) and the [Innovation Commons](/innovation-commons/).
